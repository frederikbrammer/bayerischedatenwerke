            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">61.4% success rate</p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-4xl font-bold text-red-500">32</div>
                  <p className="text-xs text-muted-foreground">25.2% loss rate</p>
                </CardContent>
              </Card>
            </div>
